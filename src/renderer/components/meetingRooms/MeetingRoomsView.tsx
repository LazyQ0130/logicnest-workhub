...
export const MeetingCreateView: React.FC<{
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-5 px-5 py-5">
      ...
      {error && <div role="alert" className="rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-600 dark:text-red-300">{error}</div>}
...
const MeetingDetailView: React.FC<{
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-5 py-5">
      ...
      {error && <div role="alert" className="mb-4 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-600 dark:text-red-300">{error}</div>}

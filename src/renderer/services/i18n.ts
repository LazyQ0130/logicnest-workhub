import { BRAND_UI_COPY } from '../config/brandUiCopy';
import { MEETING_ROOM_COPY } from '../config/meetingRoomCopy';
import { SETTINGS_CENTER_COPY } from '../config/settingsCenterCopy';
...
// 语言文本映射
const baseTranslations: Record<LanguageType, Record<string, string>> = {
  zh: {
    // 通用
    save: '保存',
    cancel: '取消',
    ...
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整逻栖工枢界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    providerCategoryTabsLabel: '模型服务商分类',
    providerCategoryInternational: '国际版',
    providerCategoryDomestic: '国内版',
    providerCategoryLocal: '本地模型',
    providerCategoryCustom: '自定义',
    customProvidersEmpty: '还没有自定义服务商',
    customProvidersEmptyTitle: '添加自定义服务商',
    customProvidersEmptyDescription: '配置兼容 OpenAI 或 Anthropic API 的模型服务。',
    ...
    shortcutOpenCowork: '打开工作中枢',
    shortcutOpenScheduledTasks: '打开自动任务',
    shortcutOpenKits: '打开方案库',
    shortcutOpenSkills: '打开技能',
    shortcutOpenMcp: '打开 MCP 服务',
    shortcutToggleSidebar: '显示/隐藏侧边栏',
    shortcutShowShortcuts: '打开快捷键设置',
    shortcutPreviousAgent: '上一个助手',
    shortcutNextAgent: '下一个助手',
    shortcutShowCurrentAgentTasks: '查看当前助手任务记录',
    shortcutOpenAgentTaskSlot: '打开当前助手任务 {slot}',
    shortcutOpenSettingsTab: '打开设置：{tab}',
    shortcutDescNewChat: '开始一个新任务',
    shortcutDescFocusPrompt: '返回工作中枢并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到工作中枢',
    shortcutDescOpenScheduledTasks: '切换到自动任务视图',
    shortcutDescOpenKits: '切换到方案库',
    ...
    shortcutDescPreviousAgent: '切换到左侧列表里的上一个助手',
    shortcutDescNextAgent: '切换到左侧列表里的下一个助手',
    shortcutDescShowCurrentAgentTasks: '展开当前助手的历史任务记录',
    shortcutDescOpenAgentTaskSlot: '打开当前助手历史任务列表中的第 {slot} 个任务',
    shortcutDescOpenSettingsTab: '切换到设置里的「{tab}」页',
    shortcutAgentTaskSlotUnavailable: '当前助手没有第 {slot} 个任务记录',
    close: '关闭',
    ...
    authQuotaExhausted:
      '当前套餐额度已用完。请在会员中心续费，或在“模型服务”中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    artifactPreviewCardLobsterBrowser: '网页访问',
    artifactPreviewCardOpenInLobsterBrowser: '在网页访问中打开',
    ...
    artifactSpreadsheetTooLarge: '表格文件超过 100 MB 预览上限',
    ...
    logicnestLicenseTitle: '逻栖工枢',
    logicnestLicenseLogin: '登录',
    logicnestLicenseRegister: '注册账号',
    logicnestLicensePhone: '手机号',
    logicnestLicenseCountryCode: '国家或地区代码',
    logicnestLicensePassword: '密码',
    logicnestLicenseConfirmPassword: '确认密码',
    logicnestLicenseShowPassword: '显示密码',
    logicnestLicenseHidePassword: '隐藏密码',
    logicnestLicenseActivationCode: '激活码',
    logicnestLicenseActivationHint: '请输入购买后获得的激活码',
    logicnestLicenseSubmit: '继续',
    logicnestLicenseRedeem: '激活授权',
    logicnestLicenseSwitchToRegister: '没有账号？注册',
    logicnestLicenseSwitchToLogin: '已有账号？登录',
    logicnestLicenseNeedActivation: '账号已创建，请输入激活码后开始使用。',
    logicnestLicenseRestricted: '授权不可用',
    logicnestLicenseOfflineGrace: '当前处于离线宽限期',
    logicnestLicenseOfflineUntil: '离线授权有效至 {time}',
    logicnestLicenseMembership: '方案：{plan} · 有效期至 {time}',
    logicnestLicenseLogout: '退出账号',
    logicnestLicenseError: '操作失败，请检查网络和输入后重试。',
    logicnestLicenseInvalidPhone: '注册失败。原因：手机号格式不正确。请输入 11 位中国大陆手机号后重试。',
    logicnestLicenseInvalidPassword: '注册失败。原因：密码长度不符合要求。请输入 8 到 128 位密码。',
    logicnestLicensePasswordMismatch: '注册失败。原因：两次输入的密码不一致。请重新确认密码。',
    logicnestLicensePhoneAlreadyRegistered: '注册失败。原因：该手机号已经注册。请直接登录或更换手机号。',
    logicnestLicenseInvalidCredentials: '登录失败。原因：手机号或密码不正确。请检查后重试。',
    logicnestLicenseDeviceUnavailable: '授权失败。原因：当前设备已绑定其他账号或已被停用。请联系管理员处理设备绑定。',
    logicnestLicenseAccountSuspended: '登录失败。原因：账号已被停用。请联系管理员恢复账号。',
    logicnestLicenseRestart: '授权成功，应用将重新启动。',
    logicnestLicenseDeviceBound: '此账号已绑定其他设备。',
    logicnestLockedWorkspace: '会员工作区',
    logicnestLockedNavigation: '受限功能导航',
    logicnestLockedAgents: '助手',
    logicnestLockedSessions: '会话',
    logicnestLockedSkills: '技能',
    logicnestLockedScheduledTasks: '自动任务',
    logicnestLockedMcp: 'MCP',
    logicnestLockedTitle: '工作区尚未激活',
    logicnestLockedDescription: '账号已登录。激活会员后即可使用助手、会话、能力、自动任务和连接服务。',
    logicnestLockedAccount: '当前账号',
    logicnestLockedMembership: '会员状态',
    logicnestLockedInactive: '未激活',
    logicnestLockedFeatureNotice: '激活会员后可使用',
    logicnestWorkspaceStarting: '正在启动工作区',
    logicnestWorkspaceStartingHint: '授权已生效，客户端正在重新启动并初始化完整工作区。',
    logicnestRestrictedHint: '当前账号或设备已受限，请退出账号后重试或联系管理员。',
    ...
    coworkWorkingDirectoryHint: '工作中枢将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为工作中枢设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义工作中枢的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '工作中枢使用“模型服务”中的当前模型与提供商配置。',
    ...
    openClawHeartbeatEnabledDescription:
      '开启后，助手每小时在后台自动巡检一次你交办的持续关注事项，有进展即主动提醒；关闭后仅在你发起对话时响应，可降低空闲时的 token 消耗。',
    ...
    engineStartingTip3: '用「自动任务」在固定时间自动执行例行工作',
    ...
    openClawRepairBusyError: '当前仍有助手任务或自动任务在运行，请停止后再修复。',
    ...
    openClawDataBackupBlockingTitle: '正在备份逻栖工枢数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入逻栖工枢数据',
    ...
    openClawDataMigrationConfirmTitle: '导入逻栖工枢数据备份？',
    ...
    coworkBootstrapSaveFailed: '助手设定保存失败',
    coworkMemoryEnabled: '启用用户记忆',
    coworkMemoryEnabledHint: 'OpenClaw 会自动索引 MEMORY.md 文件，为助手提供长期记忆检索。',
    ...
    coworkMemoryDreamingEnabled: '启用记忆整理',
    coworkMemoryDreamingEnabledHint:
      '后台定时整合记忆，将高价值条目提升为长期记忆，并生成整理记录',
    coworkMemoryDreamingFrequency: '运行频率',
    coworkMemoryDreamingFrequencyHint: '设置记忆整理的定时计划',
    ...
    coworkMemoryDreamingModel: '整理模型',
    coworkMemoryDreamingModelHint: '可选，指定生成整理记录的模型；留空使用主模型',
    // Memory tab names
    coworkMemoryTabEntries: '记忆条目管理',
    coworkMemoryTabEmbedding: 'Embedding 语义搜索',
    coworkMemoryTabDreaming: '记忆整理',
    // 记忆整理内容
    coworkDreamingSubTabScene: '概览',
    coworkDreamingSubTabDiary: '整理记录',
    coworkDreamingSubTabAdvanced: '高级',
    coworkDreamingHeaderTitle: '记忆整理',
    coworkDreamingHeaderSubtitle: '在后台回放、筛选并巩固长期信息。',
    coworkDreamingSwitchOn: '已开启',
    coworkDreamingSwitchOff: '已关闭',
    coworkDreamingInsightBrewing: '正在整理近期记忆...',
    ...
    coworkDreamingContentTitle: '整理内容',
    coworkDreamingStatusActive: '运行中',
    coworkDreamingStatusIdle: '空闲',
    coworkDreamingPromoted: '已提升',
    coworkDreamingNextSweep: '下次扫描',
    coworkDreamingPhaseLight: '快速整理',
    coworkDreamingPhaseDeep: '深度整理',
    coworkDreamingPhaseRem: '重点回放',
    coworkDreamingPhaseOff: '关闭',
    coworkDreamingDiaryTitle: '整理记录',
    coworkDreamingDiaryHint: '系统回放和整合记忆时生成的原始记录，可用于检查关注内容',
    coworkDreamingDiaryEmpty: '还没有整理记录',
    coworkDreamingDiaryEmptyHint: '启用记忆整理后，系统会在后台生成整理记录',
    ...
    coworkDreamingLoadError: '加载记忆整理数据失败',
    coworkDreamingGatewayUnavailable: '运行引擎未连接，无法加载记忆整理数据',
    coworkConfigSaveFailed: '保存工作中枢配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '工作中枢请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '工作中枢需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkCurrentAgent: '当前助手',
    coworkSelectAgent: '选择助手',
    ...
    myAgentSidebarNoAgents: '还没有助手',
    myAgentSidebarNoTasks: '暂无任务',
    myAgentSidebarNewTask: '新建任务',
    myAgentSidebarProjects: '项目',
    myAgentSidebarProjectUnavailable: '项目不可用',
    myAgentSidebarNewProjectTask: '在 {project} 中新建任务',
    ...
    agentPin: '置顶',
    agentUnpin: '取消置顶',
    agentPinFailed: '更新助手置顶失败',
    agentReorderFailed: '调整助手顺序失败',
    customCreate: '自定义创建',
    choosePreset: '选择预设',
    agentUseTemplate: '使用模板',
    agentTemplateTitle: '助手模板',
    agentTemplateNew: '新建',
    agentTemplateEmpty: '暂无可用模板',
    agentSettings: '助手设置',
    agentName: '名称',
    agentNamePlaceholder: '助手名称',
    agentAvatarPickerTitle: '选择头像',
    agentAvatarPickerDone: '完成',
    agentAvatarSvgOwl: '猫头鹰',
    ...
    agentDefaultModel: '助手默认模型',
    agentDefaultWorkingDirectory: '助手默认工作目录',
    agentDefaultWorkingDirectoryHint: '新建会话默认在此目录执行',
    agentModelInvalidHint: '当前模型已不可用，请重新选择',
    agentSystemPromptPlaceholder:
      '定义这个助手的角色、工作方式和回答风格，例如：你是专业的办公文档助理，擅长起草报告、润色邮件、整理表格要点，并保持格式清晰。',
    agentSkills: '技能',
    agentSkillsHint: '选择该助手可使用的技能。不选则使用所有已启用技能。',
    ...
    agentTabIM: 'IM 渠道',
    agentSubagentsTitle: '允许调用的助手',
    agentSubagentsHint: '选中后，当前助手可以把任务交给这些助手协助完成。',
    agentSubagentsEmpty: '暂无其他已启用助手',
    agentIMConfigured: '已配置',
    agentIMNotConfigured: '未配置',
    agentIMNotConfiguredHint: '请先在“设置 > 消息接入”中配置',
    agentIMBound: '已绑定',
    agentIMBoundToOther: '→ {agent}',
    agentIMBindHint: '选择此助手响应的消息渠道',
    agentCreateFailed: '创建助手失败',
    agentSaveFailed: '保存助手设置失败',
    agentDeleteFailed: '删除助手失败',
    agentDefaultCannotDelete: '工作中枢不能删除',
    agentDeleteConfirmTitle: '确认删除助手',
    agentDeleteConfirmMessage: '确定要删除助手「{name}」及其任务记录吗？此操作不可撤销。',
    agentUnsavedTitle: '未保存的更改',
    agentUnsavedMessage: '离开后，当前助手设置中的修改将丢失。',
    ...
    coworkGoalInputPlaceholder: '工作中枢应继续朝哪个目标推进？',
    ...
    coworkErrorLobsterAILoginExpired: '登录状态已过期，请重新登录后继续使用套餐模型。',
    ...
    userErrorCertificate: '连接失败。原因：安全证书无效、已过期或尚未被系统信任。请检查系统时间和证书信任设置后重试。',
    userErrorDns: '连接失败。原因：服务器地址无法解析。请检查网络、服务器地址或本机解析设置后重试。',
    userErrorConnectionRefused: '连接失败。原因：目标服务拒绝连接，服务可能尚未启动。请检查服务状态后重试。',
    userErrorTimeout: '操作超时。原因：网络较慢或目标服务响应过久。请稍后重试并检查网络状态。',
    userErrorNetwork: '网络连接失败。原因：当前网络不可用或连接中断。请检查网络后重试。',
    userErrorAuthentication: '身份验证失败。原因：登录状态或访问密钥无效。请重新登录或检查密钥配置。',
    userErrorPermission: '操作被拒绝。原因：当前账号或系统权限不足。请检查账号权限和系统授权。',
    userErrorRateLimit: '请求暂时受限。原因：短时间内请求次数过多。请稍后再试。',
    userErrorBalance: '服务暂不可用。原因：账户余额或调用额度不足。请补充额度后重试。',
    userErrorModelMissing: '模型调用失败。原因：所选模型不存在、已下线或当前账号无权使用。请检查模型配置。',
    userErrorInputTooLong: '任务无法提交。原因：输入内容超过模型可处理的长度。请缩短内容或新建任务后重试。',
    userErrorContentFiltered: '内容未能提交。原因：输入或输出未通过安全审核。请调整内容后重试。',
    userErrorRuntimeMissing: '本地引擎无法启动。原因：运行组件缺失或安装不完整。请使用设置中的修复功能。',
    userErrorRuntimeStart: '本地引擎启动失败。原因：运行组件异常或端口被占用。请重启应用，仍失败时执行修复。',
    userErrorRuntimeMemory: '本地引擎已停止。原因：系统可用内存不足。请关闭占用较大的程序后重试。',
    userErrorFileMissing: '文件操作失败。原因：目标文件不存在或已被移动。请重新选择文件。',
    userErrorFilePermission: '文件操作失败。原因：没有访问该文件或目录的权限。请检查权限后重试。',
    userErrorDiskFull: '文件操作失败。原因：磁盘可用空间不足。请清理空间后重试。',
    userErrorInvalidFormat: '内容无法读取。原因：文件格式不正确或内容已损坏。请检查文件后重新导入。',
    userErrorPlugin: '扩展操作失败。原因：扩展不兼容、安装不完整或配置错误。请检查扩展状态后重试。',
    userErrorMessaging: '消息渠道操作失败。原因：机器人配置、凭据或网络连接异常。请检查渠道配置后重试。',
    userErrorScheduledTask: '定时任务操作失败。原因：任务配置无效或本地引擎暂不可用。请检查任务设置后重试。',
    userErrorUpdate: '更新失败。原因：网络中断、安装包无效或被安全软件拦截。请检查网络和安全软件后重试。',
    userErrorBackup: '数据操作失败。原因：备份文件、存储空间或访问权限异常。请检查后重试。',
    userErrorUnknown: '操作失败。原因：暂时无法识别具体故障。请重试；若仍失败，请导出诊断日志并联系技术支持。',
    coworkErrorTechnicalDetails: '技术详情',
    coworkErrorModelLabel: '模型',
    coworkErrorModelSourceLobsterAIPlan: '会员套餐',
    ...
    officialSkills: '官方能力',
    addSkill: '添加',
    addSkillSecurityTip: '添加第三方能力前请确认其安全性',
    ...
    skillCreatorNotInstalled: '请先安装 skill-creator 能力',
    skillCreatorNotEnabled: '请先启用 skill-creator 能力',
    ...
    importSkill: '导入',
    importingSkill: '导入中...',
    skillImportSuccess: '能力已添加',
    official: '官方',
    noSkillsAvailable: '暂无可用能力',
    skillsDescription: '管理可复用的工作方法与工具，让工作中枢按需调用',
    skillInstalled: '已安装',
    skillMarketplace: '能力市场',
    skillMarketplaceEmpty: '暂无可用能力',
    skillCategoryAll: '全部',
    skillInstall: '安装',
    skillInstalling: '安装中',
    ...
    skillsSyncTitle: '发现新能力',
    skillsSyncFound: '检测到 {count} 个可从运行环境同步的能力：',
    skillsSyncNow: '立即同步',
    skillsSyncSkip: '暂不同步',
    skillsSyncLater: '如果现在不同步，后续可在「添加」菜单中再次同步。',
    skillsSyncNoneFound: '未发现新能力',
    skillsSyncing: '正在同步能力...',
    skillsSyncSuccess: '已成功同步能力',
    skillsSyncFailed: '同步能力失败',

    // 方案库 (Kits)
    kits: '方案库',
    newFeatureBadge: 'NEW',
    kitSearchPlaceholder: '搜索方案或能力，如“设计”、“营销”、“数据分析”',
    kitInstall: '安装',
    kitInstalling: '安装中...',
    kitUninstall: '卸载',
    ...
    kitUse: '使用',
    kitUseNow: '立即使用',
    kitInstallFailed: '方案“{name}”安装失败，请稍后重试',
    kitInstallFailedWithReason: '方案“{name}”安装失败：{reason}',
    kitUninstallFailed: '方案“{name}”卸载失败，请稍后重试',
    kitInstalledTab: '已安装',
    kitInstalledEmpty: '暂未安装方案，可前往方案市场浏览',
    kitInstallRequired: '需要安装',
    kitInstallRequiredDesc: '该方案尚未安装，是否立即安装并使用？',
    ...
    retry: '重试',
    refresh: '刷新',
    mcpDescription: '配置和管理工具连接，让工作中枢按需访问外部服务',
    searchMcpServers: '搜索连接',
    addMcpServer: '自定义',
    editMcpServer: '编辑连接',
    deleteMcpServer: '删除连接',
    mcpServerName: '服务名称',
    mcpServerNamePlaceholder: '输入服务名称',
    mcpServerDescription: '描述',
    mcpServerDescriptionPlaceholder: '描述此连接的用途',
    ...
    mcpHeaderKey: '键',
    mcpHeaderValue: '值',
    noMcpServersAvailable: '暂无连接',
    mcpDeleteConfirm: '确定删除连接“{name}”吗？',
    mcpDeleteFailed: '删除连接失败',
    mcpCreateFailed: '创建连接失败',
    mcpUpdateFailed: '更新连接失败',
    mcpBridgeSyncing: '正在同步连接工具...',
    mcpBridgeSyncDone: '连接工具同步完成',
    ...
    mcpUrlMultiple: '检测到多个 URL，请只保留一个连接 URL',
    ...
    mcpMarketplace: '市场',
    mcpCustom: '自定义',
    mcpCustomDescription: '手动配置工具连接',
    mcpResetForm: '重置',
    mcpInstall: '安装',
    mcpUninstall: '卸载',
    mcpRegistryDeleteConfirm: '确定卸载“{name}”并删除其所有连接吗？',
    mcpServersCount: '{count} 个服务',
    mcpInstallFromUrl: '通过 URL 安装',
    mcpInstallFromUrlTitle: '通过 URL 安装连接',
    ...
    mcpQichachaConnectFailed: '企查查连接授权失败',
    mcpRequiredConfig: '必填配置',
    mcpEnvRequired: '此字段为必填项',
    mcpEnvValuesRequired: '请填写必填环境变量的值：{keys}。这里应填令牌或密钥本身，不是变量名。',
    mcpEnvValuePlaceholder: '请输入令牌或密钥值',
    mcpOptionalConfig: '可选配置',
    mcpViewOnGithub: '在 GitHub 上查看',
    mcpNoInstalledServers: '尚未安装任何连接',
    mcpCategoryAll: '全部',
    ...
    emailTab: '邮箱',
    emailConfig: '邮箱配置',
    emailAccountsHint: '管理助手可使用的 IMAP/SMTP 邮箱账号。',
    emailAccount: '邮箱账号',
    ...
    pluginsInstall: '安装扩展',
    pluginsInstallTitle: '安装扩展',
    pluginsUninstall: '卸载',
    pluginsUninstalling: '卸载中...',
    pluginsUninstallConfirm: '确定要卸载此扩展吗？',
    pluginsSource: '来源',
    ...
    pluginsInstallSuccess: '扩展安装成功',
    pluginsInstallFailed: '扩展安装失败',
    pluginsEmpty: '暂无已安装扩展',
    pluginsEmptyHint: '点击右上角“安装扩展”开始',
    pluginsEnabled: '已启用',
    pluginsDisabled: '已禁用',
    pluginsConfigTitle: '扩展配置',
    pluginsConfigSave: '保存',
    pluginsConfigSaved: '已保存',
    pluginsConfigSaving: '保存中...',
    pluginsConfigBack: '返回',
    pluginsConfigNoSchema: '此扩展没有可配置项',
    pluginsConfigLoadError: '加载配置失败',
    pluginsSourceOpenclaw: '运行环境',
    pluginsSyncTitle: '发现新扩展',
    pluginsSyncDesc: '发现运行环境中的扩展并同步到管理列表。',
    pluginsSyncButton: '发现扩展',
    pluginsSyncing: '正在同步扩展...',
    pluginsSyncFound: '检测到 {count} 个可同步的扩展：',
    pluginsSyncNone: '未发现新扩展',
    pluginsSyncNow: '立即同步',
    pluginsSyncSkip: '暂不同步',
    pluginsSyncLater: '如果现在不同步，后续可在「安装扩展」中再次同步。',
    pluginsUnsavedTitle: '未保存的更改',
    pluginsUnsavedMessage: '扩展设置的修改将丢失，确认离开吗？',
    ...
    pendingSave: '待保存',
    imAgentBinding: '响应助手',
    imAgentBindingDefault: '默认（工作中枢）',
    imAgentBindingHint: '选择用于响应该平台消息的助手，不同助手有不同的人设和技能配置。',
    ...
    enableSkills: '启用技能',
    systemPrompt: '系统提示词',
    systemPromptPlaceholder: '为消息接入设置自定义指令...',
    saveConfig: '保存配置',
    ...
    imWeixinScanHint: '使用微信扫描二维码，完成微信消息接入',
    ...
    imPopoCredentialHint: '从原服务开发者后台获取 AppKey、AppSecret 和 AES Key',
    imPopoGuideStep1: '点击「扫码绑定企业消息」或手动填写凭证',
    imPopoGuideStep2: '使用企业消息客户端扫描二维码完成绑定',
    ...
    imPopoScanBtn: '扫码绑定企业消息',
    imPopoScanHint: '使用企业消息客户端扫描二维码，自动创建并关联接入',
    imPopoQrLoading: '正在生成二维码...',
    imPopoQrScanPrompt: '请使用企业消息客户端扫描下方二维码',
    ...
    browserEnableToolDescription: '允许助手打开和操作网页。',
    ...
    browserNetworkOpen: '允许访问局域网（高风险）',
    browserNetworkOpenDescription:
      '明确开启后可访问局域网地址，可能让网页内容探测路由器、NAS 或内部服务；仅在你信任当前任务时使用。',
    browserNetworkStrict: '仅允许公网与本机回环（推荐）',
    browserNetworkStrictDescription:
      '允许 localhost、127.0.0.1 和 ::1 本地开发页面，阻止局域网、链路本地和云元数据地址。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后会保留为应用配置，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '网页访问不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着网页访问不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着网页访问可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许逻栖工枢发送通知。',
    openSystemNotificationSettings: '打开系统设置',
    preventSleep: '防止休眠',
    preventSleepDescription: '防止系统在应用运行时进入睡眠模式',
    skipMissedJobs: '跳过未执行任务',
    skipMissedJobsDescription: '启动时跳过离线期间未触发的自动任务，不补充执行（保存后生效）',
    usageAnalyticsEnabled: '帮助改进逻栖工枢',
    ...
    scheduledTasksTemplateTitle: '自动任务模板',
    ...
    scheduledTasksServiceStarting: '自动任务服务正在启动...',
    scheduledTasksLoading: '正在加载自动任务...',
    scheduledTasksLoadFailed: '自动任务数据加载失败',
    scheduledTasksRetry: '重试',
    scheduledTasksEmptyState: '创建你的第一个自动任务',
    ...
    scheduledTasksFormAgentIdPlaceholder: '可选，留空使用工作中枢',
    ...
    scheduledTasksFormPayloadKindAgentTurn: '助手对话',
    ...
    scheduledTasksFormNotifyPopo: '企业消息',
    ...
    scheduledTasksFormNotifyChannel: '结果推送渠道',
    scheduledTasksFormNotifyChannelNone: '不通知',
    scheduledTasksFormNotifyChannelLoading: '正在加载可用的消息渠道...',
    scheduledTasksFormNotifyChannelLoadError: '消息渠道加载失败',
    scheduledTasksFormNotifyChannelRetry: '重试',
    scheduledTasksFormNotifyChannelEmptyPrefix: '尚未启用消息渠道，请先在',
    scheduledTasksFormNotifyChannelEmptyLink: '消息机器人设置',
    scheduledTasksFormNotifyChannelEmptySuffix: '启用一个机器人。',
    scheduledTasksRetiredChannel: '渠道已停用',
    ...
    scheduledTasksFormNotifyChannelHint: '任务完成后，可将执行结果推送到所选消息应用；这里不包含系统通知。',
    ...
    scheduledTasksDataAnomalyWarning:
      '自动任务「{name}」存在异常数据，已自动修正显示，建议重新编辑该任务',
  ...
  en: {
    ...
    uiFontSizeDescription: 'Adjust the base size used for the LogicNest WorkHub UI',
    ...
    providerCategoryTabsLabel: 'Model provider categories',
    providerCategoryInternational: 'International',
    providerCategoryDomestic: 'Domestic',
    providerCategoryLocal: 'Local Models',
    providerCategoryCustom: 'Custom',
    customProvidersEmpty: 'No custom providers yet',
    customProvidersEmptyTitle: 'Add a custom provider',
    customProvidersEmptyDescription: 'Configure a model service compatible with the OpenAI or Anthropic API.',
    ...
    copied: 'Copied',
    copyrightHolder: 'LogicNest WorkHub. All rights reserved.',
    ...
    shortcutScopeHint:
      'Quick actions run only while the LogicNest WorkHub window is focused and are ignored while editing text fields.',
    ...
    shortcutGroupCowork: 'Work Hub',
    shortcutGroupAgent: 'Assistants',
    ...
    shortcutOpenCowork: 'Open Work Hub',
    shortcutOpenScheduledTasks: 'Open Automations',
    ...
    shortcutPreviousAgent: 'Previous Assistant',
    shortcutNextAgent: 'Next Assistant',
    shortcutShowCurrentAgentTasks: 'Show Current Assistant Tasks',
    shortcutOpenAgentTaskSlot: 'Open Current Assistant Task {slot}',
    shortcutOpenSettingsTab: 'Open Settings: {tab}',
    shortcutDescNewChat: 'Start a new task',
    shortcutDescFocusPrompt: 'Return to the Work Hub and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the Work Hub',
    shortcutDescOpenScheduledTasks: 'Switch to the automations view',
    ...
    shortcutDescPreviousAgent: 'Switch to the previous assistant in the sidebar',
    shortcutDescNextAgent: 'Switch to the next assistant in the sidebar',
    shortcutDescShowCurrentAgentTasks: 'Expand the current assistant task history',
    shortcutDescOpenAgentTaskSlot: 'Open task {slot} in the current assistant history list',
    shortcutDescOpenSettingsTab: 'Switch to the {tab} tab in settings',
    shortcutAgentTaskSlotUnavailable: 'The current assistant does not have task {slot}',
    close: 'Close',
    ...
    authQuotaExhausted:
      'Your current plan quota is exhausted. Renew in Membership or configure your own API key under Model Services.',
    ...
    siteQuotaChooseHint: 'Choose an online site. The app will never stop one automatically.',
    ...
    artifactPreviewCardLobsterBrowser: 'Web Access',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in Web Access',
    ...
    artifactSpreadsheetTooLarge: 'Spreadsheet exceeds the 100 MB preview limit',
    ...
    logicnestLicenseTitle: 'LogicNest WorkHub',
    logicnestLicenseLogin: 'Sign in',
    logicnestLicenseRegister: 'Create account',
    logicnestLicensePhone: 'Phone number',
    logicnestLicenseCountryCode: 'Country or region code',
    logicnestLicensePassword: 'Password',
    logicnestLicenseConfirmPassword: 'Confirm password',
    logicnestLicenseShowPassword: 'Show password',
    logicnestLicenseHidePassword: 'Hide password',
    logicnestLicenseActivationCode: 'Activation code',
    logicnestLicenseActivationHint: 'Enter the activation code from your purchase',
    logicnestLicenseSubmit: 'Continue',
    logicnestLicenseRedeem: 'Activate license',
    logicnestLicenseSwitchToRegister: 'New here? Create an account',
    logicnestLicenseSwitchToLogin: 'Already have an account? Sign in',
    logicnestLicenseNeedActivation: 'Account created. Enter an activation code to continue.',
    logicnestLicenseRestricted: 'Authorization unavailable',
    logicnestLicenseOfflineGrace: 'You are using the offline grace period',
    logicnestLicenseOfflineUntil: 'Offline authorization is valid until {time}',
    logicnestLicenseMembership: 'Plan: {plan} · Valid until {time}',
    logicnestLicenseLogout: 'Sign out',
    logicnestLicenseError: 'The operation failed. Check your connection and try again.',
    logicnestLicenseInvalidPhone: 'Registration failed because the phone number format is invalid. Enter an 11-digit mainland China mobile number.',
    logicnestLicenseInvalidPassword: 'Registration failed because the password must contain 8 to 128 characters.',
    logicnestLicensePasswordMismatch: 'Registration failed because the passwords do not match. Re-enter the confirmation password.',
    logicnestLicensePhoneAlreadyRegistered: 'Registration failed because this phone number is already registered. Sign in or use another number.',
    logicnestLicenseInvalidCredentials: 'Sign-in failed because the phone number or password is incorrect.',
    logicnestLicenseDeviceUnavailable: 'Authorization failed because this device belongs to another account or has been disabled. Contact an administrator.',
    logicnestLicenseAccountSuspended: 'Sign-in failed because this account has been suspended. Contact an administrator.',
    logicnestLicenseRestart: 'Authorization succeeded. The app will restart.',
    logicnestLicenseDeviceBound: 'This account is bound to another device.',
    logicnestLockedWorkspace: 'Member workspace',
    logicnestLockedNavigation: 'Restricted feature navigation',
    logicnestLockedAgents: 'Assistants',
    logicnestLockedSessions: 'Sessions',
    logicnestLockedSkills: 'Skills',
    logicnestLockedScheduledTasks: 'Automations',
    logicnestLockedMcp: 'MCP',
    logicnestLockedTitle: 'Workspace not activated',
    logicnestLockedDescription: 'You are signed in. Activate membership to use assistants, sessions, capabilities, automations, and connections.',
    logicnestLockedAccount: 'Current account',
    logicnestLockedMembership: 'Membership',
    logicnestLockedInactive: 'Not activated',
    logicnestLockedFeatureNotice: 'Activate membership to use this feature',
    logicnestWorkspaceStarting: 'Starting workspace',
    logicnestWorkspaceStartingHint: 'Authorization is active. The app is restarting and initializing the complete workspace.',
    logicnestRestrictedHint: 'This account or device is restricted. Sign out and try again, or contact an administrator.',
    ...
    coworkWorkingDirectoryHint: 'The Work Hub will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for the Work Hub...',
    coworkSystemPromptHint: "Optional system prompt to customize the Work Hub's behavior",
    ...
    coworkModelSettingsHint:
      'The Work Hub uses the current model and provider configuration from Model Services.',
    ...
    engineStartingTip3:
      'Use Automations to run routine work automatically at fixed times',
    engineStartingTip4:
    ...
    openClawRepairBusyError:
      'Assistant tasks or automations are still running. Stop them before repairing.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up LogicNest WorkHub data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import LogicNest WorkHub data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import a LogicNest WorkHub data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkMemoryEnabledHint:
      'OpenClaw automatically indexes MEMORY.md for long-term memory retrieval by the assistant.',
    ...
    coworkMemoryDreamingEnabled: 'Enable Memory Organization',
    coworkMemoryDreamingEnabledHint:
      'Organize memory on a schedule, promote high-value entries to long-term memory, and generate an organization log',
    coworkMemoryDreamingFrequency: 'Schedule',
    coworkMemoryDreamingFrequencyHint: 'Set the schedule for memory organization runs',
    ...
    coworkMemoryDreamingModel: 'Organization model',
    coworkMemoryDreamingModelHint:
      'Optional. Choose the model used for organization logs, or leave empty to use the primary model.',
    // Memory tab names
    ...
    // Memory organization content
    coworkDreamingSubTabScene: 'Overview',
    coworkDreamingSubTabDiary: 'Organization Log',
    coworkDreamingSubTabAdvanced: 'Advanced',
    coworkDreamingHeaderTitle: 'Memory Organization',
    coworkDreamingHeaderSubtitle: 'Replay, filter, and consolidate long-term information in the background.',
    coworkDreamingSwitchOn: 'On',
    coworkDreamingSwitchOff: 'Off',
    coworkDreamingInsightBrewing: 'Organizing recent memories...',
    coworkDreamingInsightMessages:
    ...
    coworkDreamingContentTitle: 'Organization Content',
    ...
    coworkDreamingPhaseLight: 'Quick pass',
    coworkDreamingPhaseDeep: 'Deep pass',
    coworkDreamingPhaseRem: 'Focused replay',
    coworkDreamingPhaseOff: 'Off',
    coworkDreamingDiaryTitle: 'Organization Log',
    coworkDreamingDiaryHint:
      'Raw records generated while replaying and consolidating memory; use them to inspect what the memory system notices',
    coworkDreamingDiaryEmpty: 'No organization log yet',
    coworkDreamingDiaryEmptyHint:
      'Once Memory Organization is enabled, the system will generate organization logs in the background',
    ...
    coworkDreamingLoadError: 'Failed to load memory organization data',
    coworkDreamingGatewayUnavailable: 'Runtime engine not connected, unable to load memory organization data',
    coworkConfigSaveFailed: 'Failed to save Work Hub settings. Please try again.',
    ...
    coworkPermissionDescription: 'The Work Hub is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'The Work Hub needs your input',
    ...
    subagentWorking: 'Assistant working...',
    ...
    coworkWelcome: 'Work Hub',
    coworkDescription: 'All-scenario office assistant',
    ...
    coworkCurrentAgent: 'Current Assistant',
    coworkSelectAgent: 'Select Assistant',

    // Multi-Agent management
    createAgent: 'Create Assistant',
    myAgents: 'My Assistants',
    ...
    myAgentSidebarNoAgents: 'No assistants yet',
    ...
    agentDefaultModel: 'Assistant Default Model',
    agentDefaultWorkingDirectory: 'Assistant Default Working Directory',
    ...
    agentSystemPromptPlaceholder:
      "Define this assistant's role, workflow, and response style. Example: you are a professional office document assistant who drafts reports, polishes emails, summarizes spreadsheet highlights, and keeps formatting clear.",
    agentSkills: 'Skills',
    agentSkillsHint:
      'Select skills available to this assistant. Leave empty to use all enabled skills.',
    ...
    presetAgents: 'Preset Assistants',
    myCustomAgents: 'My Assistants',
    createNewAgent: 'New Assistant',
    addAgent: 'Add',
    ...
    agentSubagentsTitle: 'Allowed Assistants',
    agentSubagentsHint: 'After selection, this assistant can hand off tasks to these assistants for help.',
    agentSubagentsEmpty: 'No other enabled assistants',
    agentIMConfigured: 'Configured',
    agentIMNotConfigured: 'Not configured',
    agentIMNotConfiguredHint: 'Configure it in Settings > Messaging Access first',
    agentIMBound: 'Bound',
    agentIMBoundToOther: '→ {agent}',
    agentIMBindHint: 'Select messaging channels this assistant responds to',
    agentCreateFailed: 'Failed to create assistant',
    agentSaveFailed: 'Failed to save assistant settings',
    agentDeleteFailed: 'Failed to delete assistant',
    agentDefaultCannotDelete: 'The Work Hub cannot be deleted',
    agentDeleteConfirmTitle: 'Confirm Delete Assistant',
    agentDeleteConfirmMessage:
      'Are you sure you want to delete assistant "{name}" and its task history? This action cannot be undone.',
    agentUnsavedTitle: 'Unsaved Changes',
    agentUnsavedMessage: 'Your assistant setting changes will be lost if you leave.',
    ...
    coworkGoalInputPlaceholder: 'What goal should the Work Hub keep moving toward?',
    ...
    coworkErrorLobsterAILoginExpired:
      'Your login session has expired. Sign in again to continue using plan models.',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory, disk usage, and the application logs.',
    ...
    userErrorCertificate: 'Connection failed because the security certificate is invalid, expired, or untrusted. Check the system clock and certificate trust settings.',
    userErrorDns: 'Connection failed because the server address could not be resolved. Check the network and server address.',
    userErrorConnectionRefused: 'Connection failed because the target service refused the connection. Check that the service is running.',
    userErrorTimeout: 'The operation timed out. Check the network and try again later.',
    userErrorNetwork: 'The network connection failed or was interrupted. Check the network and try again.',
    userErrorAuthentication: 'Authentication failed. Sign in again or verify the access credentials.',
    userErrorPermission: 'The operation was denied because the account or system permission is insufficient.',
    userErrorRateLimit: 'Too many requests were sent in a short time. Please try again later.',
    userErrorBalance: 'The account balance or usage quota is insufficient. Add quota and try again.',
    userErrorModelMissing: 'The selected model is unavailable or inaccessible. Check the model configuration.',
    userErrorInputTooLong: 'The input exceeds the model context limit. Shorten it or start a new task.',
    userErrorContentFiltered: 'The content did not pass the safety review. Adjust it and try again.',
    userErrorRuntimeMissing: 'The local engine runtime is missing or incomplete. Use Repair in Settings.',
    userErrorRuntimeStart: 'The local engine failed to start. Restart the app or use Repair in Settings.',
    userErrorRuntimeMemory: 'The local engine stopped because available memory is insufficient.',
    userErrorFileMissing: 'The file does not exist or has been moved. Select it again.',
    userErrorFilePermission: 'The app does not have permission to access the file or folder.',
    userErrorDiskFull: 'The disk does not have enough free space. Free some space and try again.',
    userErrorInvalidFormat: 'The file format is invalid or the content is damaged.',
    userErrorPlugin: 'The extension is incompatible, incomplete, or incorrectly configured.',
    userErrorMessaging: 'The messaging channel configuration, credentials, or network connection failed.',
    userErrorScheduledTask: 'The scheduled task configuration is invalid or the local engine is unavailable.',
    userErrorUpdate: 'The update failed because of the network, installer, or security software.',
    userErrorBackup: 'The data operation failed because of the backup file, storage, or permissions.',
    userErrorUnknown: 'The operation failed for an unknown reason. Retry, then export diagnostics if it continues.',
    coworkErrorTechnicalDetails: 'Technical details',
    coworkErrorModelLabel: 'Model',
    coworkErrorModelSourceLobsterAIPlan: 'Membership plan',
    ...
    useSkill: 'Use Capability',
    searchSkills: 'Search capabilities',
    manageSkills: 'Manage Capabilities',
    officialSkills: 'Official Capabilities',
    addSkill: 'Add',
    addSkillSecurityTip: 'Verify the safety of third-party capabilities before adding',
    ...
    skillCreatorNotInstalled: 'Please install the skill-creator capability first',
    skillCreatorNotEnabled: 'Please enable the skill-creator capability first',
    githubTabLabel: 'GitHub',
    ...
    skillImportSuccess: 'Capability added',
    official: 'Official',
    noSkillsAvailable: 'No capabilities available',
    skillsDescription: 'Manage reusable work methods and tools that the Work Hub can call when needed',
    skillInstalled: 'Installed',
    skillMarketplace: 'Capability Marketplace',
    skillMarketplaceEmpty: 'No capabilities available yet',
    ...
    // Security scan
    securityScanTitle: 'Capability Security Scan',
    ...
    securityIssuesFound: 'Please be aware of the following behaviors in the {name} capability:',
    ...
    skillsSyncTitle: 'New Capabilities Detected',
    ...
    skillsSyncNoneFound: 'No new capabilities found',
    skillsSyncing: 'Syncing capabilities...',
    skillsSyncSuccess: 'Capabilities synced successfully',
    skillsSyncFailed: 'Failed to sync capabilities',
    ...
    clearKit: 'Clear Kit',
    noKitsInstalled: 'No solutions installed yet',
    ...
    kitInstallFailedWithReason: 'Failed to install "{name}": {reason}',
    kitUninstallFailed: 'Failed to uninstall "{name}". Please try again later.',
    kitInstalledTab: 'Installed',
    kitInstalledEmpty: 'No solutions installed yet. Explore the library to get started.',
    kitInstallRequired: 'Installation Required',
    kitInstallRequiredDesc: 'This solution is not installed yet. Install it now?',
    ...
    retry: 'Retry',
    refresh: 'Refresh',
    mcpDescription: 'Configure and manage tool connections that the Work Hub can access when needed',
    searchMcpServers: 'Search connections',
    addMcpServer: 'Custom',
    editMcpServer: 'Edit Connection',
    deleteMcpServer: 'Delete Connection',
    mcpServerName: 'Server Name',
    mcpServerNamePlaceholder: 'Enter server name',
    mcpServerDescription: 'Description',
    mcpServerDescriptionPlaceholder: 'Describe what this connection does',
    ...
    noMcpServersAvailable: 'No connections configured',
    mcpDeleteConfirm: 'Delete connection "{name}"?',
    mcpDeleteFailed: 'Failed to delete connection',
    mcpCreateFailed: 'Failed to create connection',
    mcpUpdateFailed: 'Failed to update connection',
    mcpBridgeSyncing: 'Syncing connection tools...',
    mcpBridgeSyncDone: 'Connection tools synced',
    ...
    mcpUrlMultiple: 'Multiple URLs detected. Keep only one connection URL.',
    ...
    mcpJsonNoServers: 'No importable connection configuration found',
    ...
    mcpCustom: 'Custom',
    mcpCustomDescription: 'Manually configure a tool connection',
    mcpResetForm: 'Reset',
    mcpInstall: 'Install',
    mcpUninstall: 'Uninstall',
    mcpRegistryDeleteConfirm: 'Uninstall "{name}" and delete all of its connections?',
    mcpServersCount: '{count} servers',
    mcpInstallFromUrl: 'Install from URL',
    mcpInstallFromUrlTitle: 'Install Connection from URL',
    ...
    mcpQichachaConnectFailed: 'Failed to authorize the Qichacha connection',
    mcpRequiredConfig: 'Required Configuration',
    mcpEnvRequired: 'This field is required',
    mcpEnvValuesRequired: 'Enter the required environment variable values: {keys}. Enter the token or secret itself, not the variable name.',
    mcpEnvValuePlaceholder: 'Enter token or secret value',
    mcpOptionalConfig: 'Optional Configuration',
    mcpViewOnGithub: 'View on GitHub',
    mcpNoInstalledServers: 'No connections installed yet',
    mcpCategoryAll: 'All',
    ...
    pluginsTitle: 'Extension Management',
    pluginsDesc: 'Install and manage extensions that add connections and automation to the Work Hub.',
    pluginsInstall: 'Install Extension',
    pluginsInstallTitle: 'Install Extension',
    pluginsUninstall: 'Uninstall',
    pluginsUninstalling: 'Uninstalling...',
    pluginsUninstallConfirm: 'Are you sure you want to uninstall this extension?',
    ...
    pluginsInstallSuccess: 'Extension installed successfully',
    pluginsInstallFailed: 'Extension installation failed',
    pluginsEmpty: 'No extensions installed',
    pluginsEmptyHint: 'Click "Install Extension" to get started',
    pluginsEnabled: 'Enabled',
    pluginsDisabled: 'Disabled',
    pluginsConfigTitle: 'Extension Settings',
    pluginsConfigSave: 'Save',
    pluginsConfigSaved: 'Saved',
    pluginsConfigSaving: 'Saving...',
    pluginsConfigBack: 'Back',
    pluginsConfigNoSchema: 'This extension has no configurable settings',
    pluginsConfigLoadError: 'Failed to load config',
    pluginsSourceOpenclaw: 'Runtime',
    pluginsSyncTitle: 'New Extensions Detected',
    pluginsSyncDesc: 'Discover runtime extensions and sync them into this list.',
    pluginsSyncButton: 'Discover Extensions',
    pluginsSyncing: 'Syncing extensions...',
    pluginsSyncFound: 'Found {count} extensions available to sync:',
    pluginsSyncNone: 'No new extensions found',
    ...
    pluginsUnsavedMessage: 'Extension setting changes will be lost. Leave anyway?',
    ...
    weixin: 'WeChat',
    wecom: 'WeCom',
    popo: 'Enterprise Messaging',
    connected: 'Connected',
    disconnected: 'Disconnected',
    connecting: 'Connecting',
    pendingSave: 'Pending save',
    imAgentBinding: 'Responding Assistant',
    imAgentBindingDefault: 'Default (Work Hub)',
    imAgentBindingHint:
      'Select the assistant that responds to messages on this platform. Different assistants have different personas and skill configurations.',
    ...
    systemPromptPlaceholder: 'Set custom instructions for messaging access...',
    ...
    // Enterprise messaging compatibility settings
    ...
    imWeixinScanHint: 'Scan the QR code with WeChat to connect messaging access',
    ...
    imPopoCredentialHint: 'Get the AppKey, AppSecret, and AES Key from the original service developer portal',
    imPopoGuideStep1: 'Click "Scan to Bind Enterprise Messaging" or enter credentials manually',
    imPopoGuideStep2: 'Scan the QR code with the enterprise messaging client to bind access',
    ...
    imPopoScanBtn: 'Scan to Bind Enterprise Messaging',
    imPopoScanHint: 'Scan with the enterprise messaging client to create and bind access',
    imPopoQrLoading: 'Generating QR code...',
    imPopoQrScanPrompt: 'Scan the QR code below with the enterprise messaging client',
    ...
    browserProfileManagedDescription:
      'Use a dedicated web environment isolated from everyday browsing data.',
    ...
    browserNetworkOpen: 'Allow private networks (high risk)',
    browserNetworkOpenDescription:
      'Explicitly allows LAN addresses, which can expose routers, NAS devices, or internal services to page content. Use only for trusted tasks.',
    browserNetworkStrict: 'Public internet and loopback only (recommended)',
    browserNetworkStrictDescription:
      'Allows localhost, 127.0.0.1, and ::1 development pages while blocking LAN, link-local, and cloud metadata addresses.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored as an app setting, but this version can still be affected by browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'Web Access will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means Web Access will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means Web Access can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow LogicNest WorkHub to send them in system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve LogicNest WorkHub',
    usageAnalyticsEnabledDescription:
    ...
    scheduledTasksLoading: 'Loading automations...',
    ...
    scheduledTasksFormAgentId: 'Agent ID',
    scheduledTasksFormAgentIdPlaceholder: 'Optional; leave blank to use the Work Hub',
    ...
    scheduledTasksFormPayloadKindAgentTurn: 'Assistant turn',
    ...
    scheduledTasksFormNotifyPopo: 'Enterprise Messaging',
    ...
    scheduledTasksFormNotifyChannel: 'Result delivery channel',
    scheduledTasksFormNotifyChannelNone: 'None',
    scheduledTasksFormNotifyChannelLoading: 'Loading available message channels...',
    scheduledTasksFormNotifyChannelLoadError: 'Failed to load message channels',
    scheduledTasksFormNotifyChannelRetry: 'Retry',
    scheduledTasksFormNotifyChannelEmptyPrefix: 'No message channel is enabled. Enable a bot in ',
    scheduledTasksFormNotifyChannelEmptyLink: 'Messaging settings',
    scheduledTasksFormNotifyChannelEmptySuffix: ' first.',
    scheduledTasksRetiredChannel: 'Channel retired',
    ...
    scheduledTasksFormNotifyChannelHint:
      'When the task finishes, its result can be sent to the selected messaging app. System notifications are separate.',
    ...
    welcomeTitle: 'Welcome to LogicNest WorkHub',
    ...
    emailAgentBinding: 'Assistant Binding',
    emailAgentBindingHint: 'All email conversations will be routed to the selected assistant',
...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: { ...baseTranslations.zh, ...BRAND_UI_COPY.zh, ...SETTINGS_CENTER_COPY.zh, ...MEETING_ROOM_COPY.zh },
  en: { ...baseTranslations.en, ...BRAND_UI_COPY.en, ...SETTINGS_CENTER_COPY.en, ...MEETING_ROOM_COPY.en },
};

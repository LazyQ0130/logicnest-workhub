...
const baseTranslations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“方案库”使用“逻栖外观工坊”，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除应用管理的皮肤副本，不会删除任务中的原始生成图片或卸载外观设计方案。',
  ...
  en: {
    ...
    aiSkinCreationGuide: 'Use LogicNest Appearance Studio from the Solution Library, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only app-managed skin copies are removed. Original task images and the appearance solution are kept.',
